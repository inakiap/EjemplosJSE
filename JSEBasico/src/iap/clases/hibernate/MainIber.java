...
public class MainIber
{
    ...
    public static void main(String args[]){
    	...
    	//Ahora sé, obtengo el objeto SessionFactory, a partir de la anterior clase /servicio
    	...
    	*/
    	...
    	{
    		session.disconnect(); // puedo usar esto en vez de cerrar para poder usarla de nuevo.
